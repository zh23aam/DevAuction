...
export default function StepsContainer() {
  ...
  const fromRight = [
    ...
    },
    {
      ...
      duration: 600,
      easing: "ease",
      properties: [{ startValue: 500, endValue: isDesktop ? 100 : 0, property: "translateX" }],
    },
  ];
  ...
  const fromLeft = [
    ...
    },
    {
      ...
      easing: "ease",
      properties: [
        { startValue: -500, endValue: isDesktop ? -100 : 0, property: "translateX" },
      ],
    },
  ];

  const dynamicPadding = windowWidth * (windowWidth <= 1285 ? 0.001 : 0.005);
